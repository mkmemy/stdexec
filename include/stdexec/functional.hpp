...
namespace stdexec {
  ...
  struct __function_constant {
    ...
    template <class... _Args>
      requires std::is_invocable_v<_FunT, _Args...>
  ...
  struct __composed {
    ...
    template <class... _Ts>
      requires std::is_invocable_v<_Fun1, _Ts...> && std::is_invocable_v<_Fun0, __call_result_t<_Fun1, _Ts...>>
    __call_result_t<_Fun0, __call_result_t<_Fun1, _Ts...>> operator()(_Ts&&... __ts) && {
      return ((_Fun0&&) __t0_)(((_Fun1&&) __t1_)((_Ts&&) __ts...));
    }

    template <class... _Ts>
      requires std::is_invocable_v<const _Fun1&, _Ts...>
            && std::is_invocable_v<const _Fun0&, __call_result_t<const _Fun1&, _Ts...>>
