...
namespace exec {
  ...
  namespace __scope {
    ...
    struct __when_empty_sender {
      ...
      template <__decays_to<__when_empty_sender> _Self, typename _Receiver, std::enable_if_t<receiver<_Receiver>, int> = 0>
    ...
    struct __nest_sender {
      ...
      template <__decays_to<__nest_sender> _Self, typename _Receiver, std::enable_if_t<receiver<_Receiver>, int> = 0>
    ...
    struct __future_rcvr {
      ...
      template < typename _Tag, __movable_value... _As, std::enable_if_t<__completion_tag<_Tag>, int> = 0>
    ...
    class __future {
     ...
     private:
      ...
      template <__decays_to<__future> _Self, typename _Receiver, std::enable_if_t<receiver<_Receiver>, int> = 0>
    ...
    struct async_scope : __immovable {
      ...
      template <typename _Constrained, std::enable_if_t<sender<_Constrained>, int> = 0>
      ...
      template <__movable_value _Env = empty_env, typename _Sender, std::enable_if_t<sender_in<_Sender, __env_t<_Env>>, int> = 0>
      ...
      inplace_stop_source& get_stop_source() noexcept {
