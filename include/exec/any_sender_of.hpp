...
namespace exec {
  namespace __any {
    ...
    template <class _EnvProvider>
      requires std::is_invocable_v<get_env_t, const _EnvProvider&>
    struct __query_vfun_fn<_EnvProvider> {
      template <class _Tag, class _Ret, class... _As>
        requires std::is_invocable_v<_Tag, env_of_t<const _EnvProvider&>, _As...>
    ...
    template <class _Queryable>
      requires(!std::is_invocable_v<get_env_t, const _Queryable&>)
    struct __query_vfun_fn<_Queryable> {
      template <class _Tag, class _Ret, class... _As>
        requires std::is_invocable_v<_Tag, const _Queryable&, _As...>
      constexpr _Ret (*operator()(_Tag (*)(_Ret (*)(_As...))) const noexcept)(void*, _As...) {
    ...
    struct __storage_vfun_fn {
      template <class _Tag, class... _As>
        requires std::is_invocable_v<_Tag, __mtype<_Tp>, _Storage&, _As...>
      ...
      class __t : __immovable {
       ...
       public:
        ...
        template <__not_decays_to<__t> _Tp>
          requires std::is_invocable_v<__create_vtable_t, __mtype<_Vtable>, __mtype<__decay_t<_Tp>>>
        __t(_Tp&& __object)
        ...
        template <class _Tp, class... _Args>
          requires std::is_invocable_v<__create_vtable_t, __mtype<_Vtable>, __mtype<_Tp>>
         ...
         private:
          template <class _Rcvr>
            requires receiver_of<_Rcvr, completion_signatures<_Sigs...>>
                  && (std::is_invocable_v<__query_vfun_fn<_Rcvr>, _Queries> && ...)
      ...
      struct __ref<completion_signatures<_Sigs...>, _Queries...> {
       private:
        ...
        struct __env_t {
          ...
          template <class _Tag, class... _As>
            requires std::is_invocable_v<const __vtable_t&, _Tag, void*, _As...>
          ...
          friend inplace_stop_token tag_invoke(get_stop_token_t, const __env_t& __self) noexcept {
       ...
       public:
        ...
        template < typename _Tag, __decays_to<__ref> _Self, class... _As, std::enable_if_t<__completion_tag<_Tag>, int> = 0>
    ...
    template <class _Env>
    using __env_t = __make_env_t<_Env, __with<get_stop_token_t, inplace_stop_token>>;
    ...
    struct __stoppable_receiver {
      ...
      struct __t {
        ...
        template <same_as<set_next_t> _SetNext, same_as<__t> _Self, class _Item>
          requires std::is_invocable_v<_SetNext, _Receiver&, _Item>
        ...
        template <same_as<set_value_t> _SetValue, same_as<__t> _Self, class... _Args>
          requires std::is_invocable_v<_SetValue, _Receiver&&, _Args...>
        ...
        template <same_as<set_error_t> _SetError, same_as<__t> _Self, class _Error>
          requires std::is_invocable_v<_SetError, _Receiver&&, _Error>
        ...
        template <same_as<set_stopped_t> _SetStopped, same_as<__t> _Self>
          requires std::is_invocable_v<_SetStopped, _Receiver&&>
    ...
    class __query_vtable<_List<_Queries...>> : public __query_vfun<_Queries>... {
     ...
     private:
      template <class _EnvProvider>
        requires(std::is_invocable_v<__query_vfun_fn<_EnvProvider>, _Queries> && ...)
    ...
    struct __sender {
      ...
      class __env_t {
       ...
       private:
        ...
        template <class _Tag, class... _As>
          requires std::is_invocable_v<const __query_vtable<_SenderQueries>&, _Tag, void*, _As...>
        friend auto tag_invoke(_Tag, const __env_t& __self, _As&&... __as) noexcept(
    ...
    class __scheduler {
     ...
     private:
      ...
      template <class _Tag, same_as<__scheduler> _Self, class... _As>
        requires std::is_invocable_v<const __query_vtable<_SchedulerQueries>&, _Tag, void*, _As...>
